...
assert.ok(forecast.marketStats.some((market) => market.label === "3+ goals"));
assert.ok(forecast.marketStats.some((market) => market.label === "4+ goals"));
assert.ok(forecast.marketStats.find((market) => market.label === "Estimated corners").value.endsWith(" total"));
assert.ok(!forecast.marketStats.find((market) => market.label === "Estimated corners").value.includes("."));
assert.ok(!forecast.marketStats.find((market) => market.label === "Estimated cards").value.includes("."));
